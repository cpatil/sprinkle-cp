Gem::Specification.new do |s|
  s.name = %q{sprinkle_cp}
  s.version = "0.1.6"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Marcus Crafter", "Mitchell Hashimoto", "Chetan Patil"]
  s.date = %q{2008-07-19}
